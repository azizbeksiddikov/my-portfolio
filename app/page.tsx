  ...
  return (
    <div className="flex min-h-screen  px-4 sm:px-8">
      ...
      <div className="flex flex-1 flex-col justify-center items-start space-y-8">
        ...
        <p className="text-lg text-left text-main-text">{description}</p>
        <div className="flex flex-col sm:flex-row sm:space-x-6 space-y-4 sm:space-y-0">
          ...
          <a
            ...
            className="px-5 py-3 bg-main-resume text-main-background rounded-md text-center hover:bg-main-subtitle hover:text-main-title"
            target="_blank"
